...
"""
Standard Deformable Transformer Decoder — used only in ONLY_DETR pretrain mode.
Kept identical to the original deformable_transformer.py implementation.
"""
...
class DeformableTransformerDecoder(nn.Module):
    def __init__(self, decoder_layer, num_layers, return_intermediate=False):
        ...
        # Set by the detection head for iterative bbox refinement
